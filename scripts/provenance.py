...
WARNING_MARKERS = [
    r"be careful", r"careful", r"beware", r"caution",
    r"watch out", r"warning",
    r"avoid", r"do not",
    r"kill your machine", r"crash(es|ed|ing)?", r"hangs?",
    r"memory load", r"memory.{0,20}(load|usage|hog|heavy)",
    r"expensive", r"heavy", r"bog(s|ged)?",
    r"hates?", r"too much", r"too many",
    r"risky?", r"gotcha", r"pitfall",
    r"if you'?re not careful", r"at your own risk",
    r"kill(s)? your", r"slow(s|er) (it|things|everything|down)",
]
